...
200+ Project Euler problems solved in C, C++, Rust, Go, Zig, Java, C#, JavaScript, Python, and ARM64 Assembly — every solution written by [Claude](https://claude.ai) (Opus 4.6 for algorithm design, with newer work on Opus 4.7; Sonnet/Haiku for language ports). Benchmarked on Apple Silicon.
...
Each language has its own **private** repository containing the solutions, benchmark harness, and per-problem results. Out of respect for [Project Euler's publishing rule](https://projecteuler.net/about#publish) — which only permits public discussion of problems 1–100 — solution code and answers for problems above 100 are kept private. This repo publishes aggregated benchmark data and analysis only; per-problem solutions and answers are intentionally not included.
...
All solutions were generated by [Claude Code](https://claude.ai/claude-code) on Apple Silicon (ARM64, macOS). Algorithm design and the first language implementation used Claude Opus 4.6, with newer work on Opus 4.7; ports to remaining languages used Claude Sonnet/Haiku, with verification that each port produces the canonical answer. Human role was architectural guidance, problem selection, and benchmark infrastructure design.

## Acknowledgments

This project would not exist without [Project Euler](https://projecteuler.net/) — a long-running collection of beautifully crafted mathematical and programming problems that has taught and challenged generations of programmers. The PE team runs the site as a labor of love and asks nothing in return; our deference to their [publishing rule](https://projecteuler.net/about#publish) above is a small acknowledgment of how much their work has given us.

If you've enjoyed Project Euler — whether through this benchmark or your own time on the site — consider [supporting them with a PayPal donation](https://www.paypal.com/donate?token=oHOLEJUuN8llbcVL3SVy8YQy68GSvHAisigCaUcyh5lFzOm-hhuHSEj2pqk6v34t_wTdh0LVgPWgzerK) (link from PE's own About page).
