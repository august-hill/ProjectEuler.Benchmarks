...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4448 measured (98.4% coverage).**
...
### Per-Invocation Cost (Common Set, 672 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (672-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.33 ms | 1766.20 s | 135,934 | 1.00× |
| 2 | **C++** | 77.77 ms | 1916.09 s | 99,610 | 1.03× |
| 3 | **Go** | 88.10 ms | 2138.66 s | 126,937 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 972 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 974 | 2026-09-06 |
