...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4366 measured (96.6% coverage).**
...
### Per-Invocation Cost (Common Set, 629 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (629-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.32 ms | 1708.05 s | 123,233 | 1.00× |
| 2 | **C++** | 75.31 ms | 1831.45 s | 91,021 | 1.03× |
| 3 | **Go** | 86.27 ms | 2104.07 s | 115,142 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 933 | 2026-09-04 |
