...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3720 measured (82.3% coverage).**
...
### Per-Invocation Cost (Common Set, 435 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (435-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 57.80 ms | 1248.47 s | 61,043 | 1.00× |
| 2 | **C++** | 60.69 ms | 1294.04 s | 49,072 | 1.05× |
| 3 | **Go** | 77.23 ms | 1538.97 s | 62,812 | 1.34× |
