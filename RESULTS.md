...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3818 measured (84.5% coverage).**
...
### Per-Invocation Cost (Common Set, 468 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (468-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 62.26 ms | 1461.83 s | 70,015 | 1.00× |
| 2 | **C++** | 67.35 ms | 1605.03 s | 56,103 | 1.08× |
| 3 | **Go** | 88.25 ms | 1858.03 s | 72,086 | 1.42× |
