...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4406 measured (97.5% coverage).**
...
### Per-Invocation Cost (Common Set, 650 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (650-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.81 ms | 1755.39 s | 130,158 | 1.00× |
| 2 | **C++** | 77.76 ms | 1889.95 s | 94,744 | 1.04× |
| 3 | **Go** | 87.81 ms | 2128.89 s | 120,719 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 951 | 2026-09-05 |
