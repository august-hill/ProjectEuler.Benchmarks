...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4453 measured (98.5% coverage).**
...
### Per-Invocation Cost (Common Set, 674 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (674-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.34 ms | 1766.59 s | 136,470 | 1.00× |
| 2 | **C++** | 77.89 ms | 1919.67 s | 99,974 | 1.03× |
| 3 | **Go** | 88.12 ms | 2139.79 s | 127,452 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 974 | 2026-09-06 |
