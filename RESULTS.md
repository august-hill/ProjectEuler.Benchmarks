...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3917 measured (86.6% coverage).**
...
### Per-Invocation Cost (Common Set, 501 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (501-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 64.55 ms | 1497.39 s | 81,668 | 1.00× |
| 2 | **C++** | 68.66 ms | 1630.56 s | 63,596 | 1.06× |
| 3 | **Go** | 84.26 ms | 1883.19 s | 79,462 | 1.31× |
