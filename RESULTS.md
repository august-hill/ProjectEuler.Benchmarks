...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3851 measured (85.2% coverage).**
...
### Per-Invocation Cost (Common Set, 479 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (479-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 63.34 ms | 1465.19 s | 74,228 | 1.00× |
| 2 | **C++** | 68.90 ms | 1611.54 s | 58,716 | 1.09× |
| 3 | **Go** | 88.38 ms | 1868.40 s | 74,792 | 1.40× |
