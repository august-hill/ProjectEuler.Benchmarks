...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3994 measured (88.3% coverage).**
...
### Per-Invocation Cost (Common Set, 527 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (527-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 67.41 ms | 1549.69 s | 88,640 | 1.00× |
| 2 | **C++** | 69.24 ms | 1657.12 s | 69,259 | 1.03× |
| 3 | **Go** | 83.45 ms | 1913.10 s | 86,465 | 1.24× |
