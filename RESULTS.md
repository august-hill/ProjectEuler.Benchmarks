...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3732 measured (82.5% coverage).**
...
### Per-Invocation Cost (Common Set, 439 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (439-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 58.66 ms | 1277.23 s | 61,766 | 1.00× |
| 2 | **C++** | 61.52 ms | 1299.20 s | 49,765 | 1.05× |
| 3 | **Go** | 78.26 ms | 1543.92 s | 63,567 | 1.33× |
