...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4011 measured (88.7% coverage).**
...
### Per-Invocation Cost (Common Set, 533 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (533-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 67.96 ms | 1551.48 s | 90,559 | 1.00× |
| 2 | **C++** | 70.09 ms | 1659.28 s | 70,528 | 1.03× |
| 3 | **Go** | 84.60 ms | 1916.32 s | 87,975 | 1.24× |
