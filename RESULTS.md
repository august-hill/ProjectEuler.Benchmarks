...
> **Scope: 4600 in-scope cells across 1000 problems × tiered languages — 3343 measured (72.7% coverage).**
...
### Per-Invocation Cost (Common Set, 233 of ≤700 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Total (233-problem common set) | Lines of code | vs Fastest |
|------|----------|--------------------:|--------------:|-----------:|
| 1 | **Rust** | 738.41 s | 28,662 | 1.00× |
| 2 | **C++** | 864.97 s | 26,328 | 1.17× |
| 3 | **Go** | 873.63 s | 29,872 | 1.18× |
