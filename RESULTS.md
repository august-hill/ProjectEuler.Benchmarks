...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4500 measured (99.5% coverage).**
...
### Per-Invocation Cost (Common Set, 698 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (698-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 76.02 ms | 1779.08 s | 144,193 | 1.00× |
| 2 | **C++** | 81.02 ms | 1970.07 s | 105,856 | 1.07× |
| 3 | **Go** | 89.18 ms | 2154.16 s | 134,864 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 998 | 2026-09-09 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 1000 | 2026-09-11 |
