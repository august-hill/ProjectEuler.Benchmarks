...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3702 measured (81.9% coverage).**
...
### Per-Invocation Cost (Common Set, 429 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (429-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 56.17 ms | 1202.65 s | 59,271 | 1.00× |
| 2 | **C++** | 60.13 ms | 1281.25 s | 47,719 | 1.07× |
| 3 | **Go** | 74.95 ms | 1485.34 s | 61,129 | 1.33× |
