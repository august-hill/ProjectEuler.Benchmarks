...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4358 measured (96.4% coverage).**
...
### Per-Invocation Cost (Common Set, 624 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (624-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.64 ms | 1707.68 s | 121,156 | 1.00× |
| 2 | **C++** | 75.45 ms | 1830.59 s | 89,874 | 1.02× |
| 3 | **Go** | 86.79 ms | 2103.66 s | 113,826 | 1.18× |
