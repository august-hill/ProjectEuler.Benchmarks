...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3964 measured (87.7% coverage).**
...
### Per-Invocation Cost (Common Set, 517 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (517-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 67.22 ms | 1545.68 s | 86,133 | 1.00× |
| 2 | **C++** | 69.88 ms | 1655.33 s | 67,015 | 1.04× |
| 3 | **Go** | 84.77 ms | 1911.33 s | 83,987 | 1.26× |
