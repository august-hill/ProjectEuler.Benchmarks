...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4074 measured (90.1% coverage).**
...
### Per-Invocation Cost (Common Set, 554 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (554-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 70.22 ms | 1620.66 s | 96,732 | 1.00× |
| 2 | **C++** | 70.80 ms | 1676.58 s | 75,505 | 1.01× |
| 3 | **Go** | 85.80 ms | 1995.86 s | 94,415 | 1.22× |
