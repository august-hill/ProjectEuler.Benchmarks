...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4444 measured (98.3% coverage).**
...
### Per-Invocation Cost (Common Set, 670 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (670-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.85 ms | 1764.73 s | 135,479 | 1.00× |
| 2 | **C++** | 77.09 ms | 1913.21 s | 99,202 | 1.03× |
| 3 | **Go** | 87.45 ms | 2136.44 s | 126,525 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 970 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 972 | 2026-09-06 |
