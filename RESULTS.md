...
| 2 | **C++** | 331.63 ms | 2,010 | 2.44× |
| 3 | **C** | 337.49 ms | 2,525 | 2.48× |
| 4 | **Rust** | 343.40 ms | 2,159 | 2.52× |
| 5 | **Go** | 373.63 ms | 2,354 | 2.74× |
| 6 | **JavaScript** | 404.99 ms | 1,684 | 2.97× |
| 7 | **Java** | 458.83 ms | 2,119 | 3.37× |
| 8 | **ARM64** | 494.75 ms | 6,592 | 3.63× |
