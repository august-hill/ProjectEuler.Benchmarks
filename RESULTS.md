...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4391 measured (97.1% coverage).**
...
### Per-Invocation Cost (Common Set, 643 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (643-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.51 ms | 1741.30 s | 128,187 | 1.00× |
| 2 | **C++** | 76.29 ms | 1881.51 s | 93,344 | 1.04× |
| 3 | **Go** | 86.62 ms | 2115.04 s | 118,999 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 944 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 945 | 2026-09-05 |
