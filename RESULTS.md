...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4480 measured (99.1% coverage).**
...
### Per-Invocation Cost (Common Set, 688 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (688-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 76.31 ms | 1773.41 s | 140,184 | 1.00× |
| 2 | **C++** | 79.94 ms | 1942.84 s | 103,013 | 1.05× |
| 3 | **Go** | 89.51 ms | 2148.63 s | 131,757 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 988 | 2026-09-07 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 990 | 2026-09-08 |
