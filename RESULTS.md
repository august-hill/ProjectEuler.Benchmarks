...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4383 measured (96.9% coverage).**
...
### Per-Invocation Cost (Common Set, 638 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (638-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.69 ms | 1725.82 s | 126,697 | 1.00× |
| 2 | **C++** | 75.97 ms | 1867.38 s | 92,534 | 1.03× |
| 3 | **Go** | 86.76 ms | 2112.70 s | 117,438 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 940 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 941 | 2026-09-05 |
