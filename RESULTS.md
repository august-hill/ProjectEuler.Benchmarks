...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4125 measured (91.2% coverage).**
...
### Per-Invocation Cost (Common Set, 571 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (571-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 71.32 ms | 1644.62 s | 101,786 | 1.00× |
| 2 | **C++** | 71.48 ms | 1728.60 s | 79,951 | 1.00× |
| 3 | **Go** | 87.17 ms | 2034.90 s | 99,732 | 1.22× |
