...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4122 measured (91.2% coverage).**
...
### Per-Invocation Cost (Common Set, 570 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (570-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 72.15 ms | 1644.62 s | 101,644 | 1.00× |
| 2 | **C++** | 72.31 ms | 1728.60 s | 79,853 | 1.00× |
| 3 | **Go** | 88.22 ms | 2034.90 s | 99,630 | 1.22× |
