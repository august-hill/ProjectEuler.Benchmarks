...
> **Scope: 4600 in-scope cells across 1000 problems × tiered languages — 3476 measured (75.6% coverage).**
...
### Per-Invocation Cost (Common Set, 299 of ≤700 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Total (299-problem common set) | Lines of code | vs Fastest |
|------|----------|--------------------:|--------------:|-----------:|
| 1 | **Rust** | 1004.36 s | 36,421 | 1.00× |
| 2 | **C++** | 1116.15 s | 32,946 | 1.11× |
| 3 | **Go** | 1225.15 s | 38,312 | 1.22× |
