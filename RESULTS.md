...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4463 measured (98.7% coverage).**
...
### Per-Invocation Cost (Common Set, 679 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (679-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.03 ms | 1767.29 s | 137,518 | 1.00× |
| 2 | **C++** | 77.90 ms | 1920.43 s | 101,058 | 1.04× |
| 3 | **Go** | 88.04 ms | 2140.54 s | 128,715 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 979 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 982 | 2026-09-06 |
