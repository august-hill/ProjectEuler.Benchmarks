...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4441 measured (98.2% coverage).**
...
### Per-Invocation Cost (Common Set, 668 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (668-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.55 ms | 1763.46 s | 134,936 | 1.00× |
| 2 | **C++** | 76.78 ms | 1911.54 s | 98,720 | 1.03× |
| 3 | **Go** | 86.96 ms | 2135.15 s | 125,997 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 968 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 971 | 2026-09-06 |
