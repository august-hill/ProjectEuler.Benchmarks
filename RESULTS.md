...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4503 measured (99.6% coverage).**
...
### Per-Invocation Cost (Common Set, 700 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (700-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 77.04 ms | 1798.43 s | 145,128 | 1.00× |
| 2 | **C++** | 81.89 ms | 1979.14 s | 106,296 | 1.06× |
| 3 | **Go** | 90.45 ms | 2180.34 s | 135,622 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 1000 | 2026-09-11 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 1001 | 2026-09-11 |
