...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4134 measured (91.4% coverage).**
...
### Per-Invocation Cost (Common Set, 574 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (574-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 72.05 ms | 1647.52 s | 102,616 | 1.00× |
| 2 | **C++** | 72.06 ms | 1729.65 s | 80,579 | 1.00× |
| 3 | **Go** | 88.11 ms | 2037.94 s | 100,612 | 1.22× |
