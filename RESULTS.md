...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4478 measured (99.0% coverage).**
...
### Per-Invocation Cost (Common Set, 687 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (687-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.90 ms | 1770.33 s | 139,548 | 1.00× |
| 2 | **C++** | 79.36 ms | 1930.37 s | 102,743 | 1.05× |
| 3 | **Go** | 89.13 ms | 2146.94 s | 131,419 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 987 | 2026-09-07 |
