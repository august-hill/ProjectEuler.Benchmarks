...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4377 measured (96.8% coverage).**
...
### Per-Invocation Cost (Common Set, 635 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (635-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 72.96 ms | 1722.85 s | 125,353 | 1.00× |
| 2 | **C++** | 74.99 ms | 1856.33 s | 91,998 | 1.03× |
| 3 | **Go** | 85.75 ms | 2108.66 s | 116,700 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 937 | 2026-09-05 |
