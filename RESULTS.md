...
> **Scope: 4615 in-scope cells across 1005 problems × tiered languages — 3584 measured (77.7% coverage).**
...
### Per-Invocation Cost (Common Set, 322 of ≤705 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (322-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 52.51 ms | 1104.24 s | 39,713 | 1.00× |
| 2 | **C++** | 58.92 ms | 1223.53 s | 35,505 | 1.12× |
| 3 | **Go** | 71.11 ms | 1382.28 s | 41,624 | 1.35× |
