...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3949 measured (87.3% coverage).**
...
### Per-Invocation Cost (Common Set, 512 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (512-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 68.65 ms | 1544.59 s | 84,780 | 1.00× |
| 2 | **C++** | 72.07 ms | 1655.07 s | 66,300 | 1.05× |
| 3 | **Go** | 87.37 ms | 1910.54 s | 82,934 | 1.27× |
