...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4336 measured (95.9% coverage).**
...
### Per-Invocation Cost (Common Set, 608 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (608-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.15 ms | 1700.78 s | 114,871 | 1.00× |
| 2 | **C++** | 74.29 ms | 1812.16 s | 86,483 | 1.00× |
| 3 | **Go** | 87.46 ms | 2077.23 s | 109,259 | 1.18× |
