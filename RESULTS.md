...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3779 measured (83.6% coverage).**
...
### Per-Invocation Cost (Common Set, 455 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (455-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 63.39 ms | 1458.56 s | 66,717 | 1.00× |
| 2 | **C++** | 67.67 ms | 1600.49 s | 53,326 | 1.07× |
| 3 | **Go** | 86.80 ms | 1816.35 s | 68,110 | 1.37× |
