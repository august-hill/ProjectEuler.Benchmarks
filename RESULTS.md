...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4439 measured (98.2% coverage).**
...
### Per-Invocation Cost (Common Set, 667 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (667-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.94 ms | 1763.45 s | 134,788 | 1.00× |
| 2 | **C++** | 77.07 ms | 1911.53 s | 98,392 | 1.03× |
| 3 | **Go** | 87.11 ms | 2135.12 s | 125,753 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 967 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 970 | 2026-09-06 |
