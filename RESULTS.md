...
### Per-Invocation Cost (Common Set, 623 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (623-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.57 ms | 1707.54 s | 120,617 | 1.00× |
| 2 | **C++** | 75.16 ms | 1829.73 s | 89,508 | 1.02× |
| 3 | **Go** | 86.76 ms | 2103.55 s | 113,478 | 1.18× |
