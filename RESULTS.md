...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4344 measured (96.1% coverage).**
...
### Per-Invocation Cost (Common Set, 616 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (616-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.91 ms | 1704.57 s | 117,349 | 1.00× |
| 2 | **C++** | 75.18 ms | 1822.81 s | 87,733 | 1.02× |
| 3 | **Go** | 87.06 ms | 2096.46 s | 110,924 | 1.18× |
