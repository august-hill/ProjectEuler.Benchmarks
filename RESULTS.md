...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3929 measured (86.9% coverage).**
...
### Per-Invocation Cost (Common Set, 505 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (505-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 66.37 ms | 1527.75 s | 82,712 | 1.00× |
| 2 | **C++** | 70.03 ms | 1643.63 s | 64,530 | 1.06× |
| 3 | **Go** | 85.69 ms | 1898.79 s | 80,496 | 1.29× |
