...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4058 measured (89.8% coverage).**
...
### Per-Invocation Cost (Common Set, 548 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (548-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 70.57 ms | 1571.51 s | 95,490 | 1.00× |
| 2 | **C++** | 71.46 ms | 1675.69 s | 74,302 | 1.01× |
| 3 | **Go** | 85.92 ms | 1937.67 s | 93,155 | 1.22× |
