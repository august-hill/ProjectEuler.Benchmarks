...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4119 measured (91.1% coverage).**
...
### Per-Invocation Cost (Common Set, 569 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (569-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 72.01 ms | 1644.41 s | 101,400 | 1.00× |
| 2 | **C++** | 72.16 ms | 1728.36 s | 79,645 | 1.00× |
| 3 | **Go** | 87.85 ms | 2033.98 s | 99,405 | 1.22× |
