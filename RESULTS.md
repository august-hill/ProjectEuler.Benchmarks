...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4408 measured (97.5% coverage).**
...
### Per-Invocation Cost (Common Set, 651 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (651-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.06 ms | 1756.04 s | 130,483 | 1.00× |
| 2 | **C++** | 77.95 ms | 1890.32 s | 94,869 | 1.04× |
| 3 | **Go** | 87.77 ms | 2128.95 s | 120,992 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 952 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 954 | 2026-09-05 |
