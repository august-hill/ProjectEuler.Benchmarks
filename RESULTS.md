...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4343 measured (96.1% coverage).**
...
### Per-Invocation Cost (Common Set, 615 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (615-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.64 ms | 1703.85 s | 116,980 | 1.00× |
| 2 | **C++** | 75.04 ms | 1822.57 s | 87,488 | 1.02× |
| 3 | **Go** | 86.75 ms | 2095.69 s | 110,619 | 1.18× |
