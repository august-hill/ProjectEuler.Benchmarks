...
> **Scope: 4621 in-scope cells across 1007 problems × tiered languages — 3636 measured (78.7% coverage).**
...
### Per-Invocation Cost (Common Set, 340 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (340-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 52.78 ms | 1116.11 s | 44,012 | 1.00× |
| 2 | **C++** | 58.97 ms | 1232.70 s | 38,653 | 1.12× |
| 3 | **Go** | 73.47 ms | 1404.41 s | 45,800 | 1.39× |
