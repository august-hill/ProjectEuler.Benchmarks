...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4455 measured (98.5% coverage).**
...
### Per-Invocation Cost (Common Set, 675 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (675-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.56 ms | 1767.15 s | 136,771 | 1.00× |
| 2 | **C++** | 78.01 ms | 1919.89 s | 100,135 | 1.03× |
| 3 | **Go** | 88.27 ms | 2140.07 s | 127,733 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 975 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 978 | 2026-09-06 |
