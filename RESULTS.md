...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4502 measured (99.6% coverage).**
...
### Per-Invocation Cost (Common Set, 699 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (699-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 76.60 ms | 1794.30 s | 144,516 | 1.00× |
| 2 | **C++** | 81.36 ms | 1971.62 s | 106,030 | 1.06× |
| 3 | **Go** | 89.86 ms | 2171.92 s | 135,098 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 999 | 2026-09-11 |
