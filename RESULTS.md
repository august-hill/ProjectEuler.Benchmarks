...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4341 measured (96.0% coverage).**
...
### Per-Invocation Cost (Common Set, 613 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (613-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.06 ms | 1703.51 s | 116,449 | 1.00× |
| 2 | **C++** | 75.37 ms | 1822.25 s | 87,210 | 1.02× |
| 3 | **Go** | 87.03 ms | 2095.34 s | 110,283 | 1.18× |
