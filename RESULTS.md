...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4429 measured (98.0% coverage).**
...
### Per-Invocation Cost (Common Set, 662 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (662-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.12 ms | 1762.50 s | 133,478 | 1.00× |
| 2 | **C++** | 77.90 ms | 1908.83 s | 97,139 | 1.04× |
| 3 | **Go** | 87.18 ms | 2132.42 s | 123,945 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 962 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 965 | 2026-09-06 |
