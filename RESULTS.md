...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4447 measured (98.4% coverage).**
...
### Per-Invocation Cost (Common Set, 671 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (671-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.03 ms | 1765.11 s | 135,643 | 1.00× |
| 2 | **C++** | 77.42 ms | 1914.52 s | 99,403 | 1.03× |
| 3 | **Go** | 87.80 ms | 2137.74 s | 126,798 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 971 | 2026-09-06 |
