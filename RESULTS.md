...
> **Scope: 4621 in-scope cells across 1007 problems × tiered languages — 3602 measured (77.9% coverage).**
...
### Per-Invocation Cost (Common Set, 328 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (328-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 53.36 ms | 1107.85 s | 40,662 | 1.00× |
| 2 | **C++** | 60.01 ms | 1227.98 s | 36,451 | 1.12× |
| 3 | **Go** | 73.03 ms | 1387.94 s | 42,797 | 1.37× |
