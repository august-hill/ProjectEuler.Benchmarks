...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4497 measured (99.5% coverage).**
...
### Per-Invocation Cost (Common Set, 697 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (697-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.73 ms | 1777.90 s | 143,895 | 1.00× |
| 2 | **C++** | 80.54 ms | 1965.17 s | 105,532 | 1.06× |
| 3 | **Go** | 88.79 ms | 2152.14 s | 134,522 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 997 | 2026-09-09 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 998 | 2026-09-09 |
