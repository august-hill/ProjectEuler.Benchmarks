...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4083 measured (90.3% coverage).**
...
### Per-Invocation Cost (Common Set, 557 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (557-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 69.48 ms | 1620.82 s | 97,366 | 1.00× |
| 2 | **C++** | 69.74 ms | 1676.78 s | 76,083 | 1.00× |
| 3 | **Go** | 85.27 ms | 1996.18 s | 95,389 | 1.23× |
