...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4460 measured (98.7% coverage).**
...
### Per-Invocation Cost (Common Set, 678 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (678-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.35 ms | 1767.28 s | 137,323 | 1.00× |
| 2 | **C++** | 78.16 ms | 1920.42 s | 100,668 | 1.04× |
| 3 | **Go** | 88.37 ms | 2140.53 s | 128,345 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 978 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 980 | 2026-09-06 |
