...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4489 measured (99.3% coverage).**
...
### Per-Invocation Cost (Common Set, 693 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (693-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 76.68 ms | 1777.44 s | 142,272 | 1.00× |
| 2 | **C++** | 80.18 ms | 1962.62 s | 104,625 | 1.05× |
| 3 | **Go** | 89.05 ms | 2150.04 s | 133,273 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 993 | 2026-09-08 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 994 | 2026-09-08 |
