...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3955 measured (87.5% coverage).**
...
### Per-Invocation Cost (Common Set, 514 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (514-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 68.80 ms | 1545.66 s | 85,492 | 1.00× |
| 2 | **C++** | 71.48 ms | 1655.32 s | 66,616 | 1.04× |
| 3 | **Go** | 86.58 ms | 1911.28 s | 83,384 | 1.26× |
