...
> **Scope: 4615 in-scope cells across 1005 problems × tiered languages — 3587 measured (77.7% coverage).**
...
### Per-Invocation Cost (Common Set, 323 of ≤705 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (323-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 52.84 ms | 1104.64 s | 39,828 | 1.00× |
| 2 | **C++** | 59.39 ms | 1224.29 s | 35,587 | 1.12× |
| 3 | **Go** | 71.75 ms | 1383.58 s | 41,741 | 1.36× |
