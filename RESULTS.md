...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4363 measured (96.5% coverage).**
...
### Per-Invocation Cost (Common Set, 627 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (627-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.40 ms | 1707.82 s | 122,398 | 1.00× |
| 2 | **C++** | 75.40 ms | 1831.25 s | 90,618 | 1.03× |
| 3 | **Go** | 86.21 ms | 2103.83 s | 114,378 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 932 | 2026-09-04 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 929 | 2026-09-04 |
