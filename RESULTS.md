...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4403 measured (97.4% coverage).**
...
### Per-Invocation Cost (Common Set, 648 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (648-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.44 ms | 1754.47 s | 129,697 | 1.00× |
| 2 | **C++** | 77.20 ms | 1888.29 s | 94,425 | 1.04× |
| 3 | **Go** | 87.36 ms | 2127.84 s | 120,391 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 949 | 2026-09-05 |
