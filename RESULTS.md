...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4405 measured (97.4% coverage).**
...
### Per-Invocation Cost (Common Set, 649 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (649-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.55 ms | 1754.66 s | 129,910 | 1.00× |
| 2 | **C++** | 77.49 ms | 1889.17 s | 94,562 | 1.04× |
| 3 | **Go** | 87.52 ms | 2128.12 s | 120,511 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 950 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 953 | 2026-09-05 |
