...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4450 measured (98.4% coverage).**
...
### Per-Invocation Cost (Common Set, 673 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (673-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.16 ms | 1766.21 s | 136,094 | 1.00× |
| 2 | **C++** | 77.45 ms | 1916.10 s | 99,777 | 1.03× |
| 3 | **Go** | 87.78 ms | 2138.66 s | 127,202 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 973 | 2026-09-06 |
