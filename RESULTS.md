...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4375 measured (96.8% coverage).**
...
### Per-Invocation Cost (Common Set, 634 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (634-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 72.50 ms | 1718.61 s | 124,990 | 1.00× |
| 2 | **C++** | 74.47 ms | 1850.22 s | 91,831 | 1.03× |
| 3 | **Go** | 85.27 ms | 2105.55 s | 116,429 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 936 | 2026-09-04 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 937 | 2026-09-04 |
