...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4365 measured (96.5% coverage).**
...
### Per-Invocation Cost (Common Set, 628 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (628-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.52 ms | 1708.04 s | 122,652 | 1.00× |
| 2 | **C++** | 75.51 ms | 1831.44 s | 90,665 | 1.03× |
| 3 | **Go** | 86.32 ms | 2104.01 s | 114,766 | 1.17× |
...
| **Go** | `go version go1.26.5 darwin/arm64` | 931 | 2026-09-04 |
