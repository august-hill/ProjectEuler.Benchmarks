...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4052 measured (89.6% coverage).**
...
### Per-Invocation Cost (Common Set, 546 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (546-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 70.77 ms | 1571.42 s | 95,000 | 1.00× |
| 2 | **C++** | 72.47 ms | 1675.69 s | 73,897 | 1.02× |
| 3 | **Go** | 86.25 ms | 1937.55 s | 92,715 | 1.22× |
