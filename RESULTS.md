...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4116 measured (91.0% coverage).**
...
### Per-Invocation Cost (Common Set, 568 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (568-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 71.74 ms | 1643.79 s | 101,130 | 1.00× |
| 2 | **C++** | 71.89 ms | 1727.73 s | 79,446 | 1.00× |
| 3 | **Go** | 87.48 ms | 2033.02 s | 99,210 | 1.22× |
