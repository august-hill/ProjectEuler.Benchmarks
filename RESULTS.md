...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3866 measured (85.5% coverage).**
...
### Per-Invocation Cost (Common Set, 484 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (484-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 62.63 ms | 1465.89 s | 75,894 | 1.00× |
| 2 | **C++** | 68.17 ms | 1612.50 s | 59,726 | 1.09× |
| 3 | **Go** | 86.44 ms | 1869.00 s | 75,444 | 1.38× |
