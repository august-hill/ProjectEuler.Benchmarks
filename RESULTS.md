...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4399 measured (97.3% coverage).**
...
### Per-Invocation Cost (Common Set, 646 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (646-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.13 ms | 1750.66 s | 129,064 | 1.00× |
| 2 | **C++** | 76.99 ms | 1885.15 s | 93,851 | 1.04× |
| 3 | **Go** | 87.27 ms | 2123.32 s | 119,784 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 947 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 950 | 2026-09-05 |
