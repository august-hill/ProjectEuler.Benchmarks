...
> **Scope: 4600 in-scope cells across 1000 problems × tiered languages — 3411 measured (74.2% coverage).**
...
### Per-Invocation Cost (Common Set, 267 of ≤700 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Total (267-problem common set) | Lines of code | vs Fastest |
|------|----------|--------------------:|--------------:|-----------:|
| 1 | **Rust** | 739.44 s | 32,371 | 1.00× |
| 2 | **C++** | 866.03 s | 29,559 | 1.17× |
| 3 | **Go** | 877.21 s | 34,090 | 1.19× |
