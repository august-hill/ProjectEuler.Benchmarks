...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4092 measured (90.5% coverage).**
...
### Per-Invocation Cost (Common Set, 560 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (560-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 70.15 ms | 1630.00 s | 98,202 | 1.00× |
| 2 | **C++** | 70.41 ms | 1685.26 s | 76,517 | 1.00× |
| 3 | **Go** | 85.54 ms | 2017.97 s | 96,230 | 1.22× |
