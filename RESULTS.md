...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3848 measured (85.1% coverage).**
...
### Per-Invocation Cost (Common Set, 478 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (478-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 63.45 ms | 1465.16 s | 73,940 | 1.00× |
| 2 | **C++** | 69.06 ms | 1611.51 s | 58,515 | 1.09× |
| 3 | **Go** | 88.29 ms | 1868.25 s | 74,631 | 1.39× |
