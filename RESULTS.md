...
> **Scope: 3100 in-scope cells across 500 problems × tiered languages — 2618 measured (84.5% coverage).**
...
### Per-Invocation Cost (Common Set, 56 of ≤200 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Total (56-problem common set) | Lines of code | vs Fastest |
|------|----------|--------------------:|--------------:|-----------:|
| 1 | **C++** | 20.72 s | 6,152 | 1.00× |
| 2 | **Rust** | 21.54 s | 6,108 | 1.04× |
| 3 | **Go** | 28.60 s | 6,282 | 1.38× |
