...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4400 measured (97.3% coverage).**
...
### Per-Invocation Cost (Common Set, 647 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (647-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.99 ms | 1750.68 s | 129,378 | 1.00× |
| 2 | **C++** | 76.76 ms | 1885.16 s | 94,081 | 1.04× |
| 3 | **Go** | 86.83 ms | 2123.32 s | 120,070 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 948 | 2026-09-05 |
