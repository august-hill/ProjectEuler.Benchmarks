...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4396 measured (97.2% coverage).**
...
### Per-Invocation Cost (Common Set, 645 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (645-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.24 ms | 1750.63 s | 128,685 | 1.00× |
| 2 | **C++** | 76.94 ms | 1885.04 s | 93,638 | 1.04× |
| 3 | **Go** | 87.48 ms | 2123.30 s | 119,410 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 946 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 948 | 2026-09-05 |
