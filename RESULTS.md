...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4421 measured (97.8% coverage).**
...
### Per-Invocation Cost (Common Set, 658 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (658-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.59 ms | 1761.09 s | 132,448 | 1.00× |
| 2 | **C++** | 78.48 ms | 1903.20 s | 96,280 | 1.04× |
| 3 | **Go** | 87.95 ms | 2131.48 s | 122,551 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 958 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 961 | 2026-09-06 |
