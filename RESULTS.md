...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4511 measured (99.8% coverage).**
...
### Per-Invocation Cost (Common Set, 703 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (703-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 78.09 ms | 1805.43 s | 146,116 | 1.00× |
| 2 | **C++** | 82.73 ms | 1982.26 s | 107,104 | 1.06× |
| 3 | **Go** | 91.82 ms | 2191.80 s | 137,052 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 1003 | 2026-09-12 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 1004 | 2026-09-12 |
