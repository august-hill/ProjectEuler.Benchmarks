...
|------|----------|-----------|------|----------|------|
| 1 | **Zig** | 14.64s | 0.49x | 64 | 53 |
| 2 | **ARM64** | 19.66s | 0.66x | 198 | 36 |
| 3 | **C** | 29.63s | 1.00x | 70 | 32 |
| 4 | **C++** | 30.98s | 1.05x | 49 | 16 |
| 5 | **C#** | 37.86s | 1.28x | 52 | 0 |
| 6 | **Go** | 40.76s | 1.38x | 62 | 3 |
| 7 | **Rust** | 51.86s | 1.75x | 55 | 18 |
| 8 | **Java** | 71.74s | 2.42x | 50 | 1 |
| 9 | **JS** | 76.36s | 2.58x | 43 | 3 |
| 10 | **Python** | 260.70s | 8.80x | 40 | 0 |

*162 common problems, excluding 4 parked (algorithm redesign needed)*
