...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4020 measured (88.9% coverage).**
...
### Per-Invocation Cost (Common Set, 536 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (536-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 68.90 ms | 1554.87 s | 91,443 | 1.00× |
| 2 | **C++** | 71.20 ms | 1662.80 s | 71,347 | 1.03× |
| 3 | **Go** | 85.72 ms | 1919.36 s | 89,037 | 1.24× |
