...
| **Rust** | 1.2 µs | 84 ns | 28.2 µs | 13.3 µs | 417 ns | 42 ns | 849.4 µs | 9.3 µs | 250 ns | 2.08 ms |
...
| **Java** | 23.3 µs | 3.0 µs | 8.3 µs | 292.2 µs | 4.4 µs | 2.2 µs | 1.57 ms | 307.8 µs | 6.1 µs | 8.07 ms |
| **JavaScript** | 16.3 µs | 11.7 µs | 54.8 µs | 91.3 µs | 28.8 µs | 6.8 µs | 2.65 ms | 95.7 µs | 27.7 µs | 10.09 ms |
| **C#** | 298.8 µs | 267.0 µs | 1.81 ms | 307.5 µs | 2.03 ms | 210.5 µs | 919.5 µs | 8.07 ms | 663.5 µs | 9.93 ms |
