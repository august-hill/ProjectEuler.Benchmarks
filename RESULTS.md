...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4417 measured (97.7% coverage).**
...
### Per-Invocation Cost (Common Set, 655 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (655-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.77 ms | 1760.80 s | 131,799 | 1.00× |
| 2 | **C++** | 78.72 ms | 1902.98 s | 95,820 | 1.04× |
| 3 | **Go** | 87.91 ms | 2131.19 s | 122,026 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 956 | 2026-09-06 |
