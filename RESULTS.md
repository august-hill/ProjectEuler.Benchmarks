...
> **Scope: 4615 in-scope cells across 1005 problems × tiered languages — 3581 measured (77.6% coverage).**
...
### Per-Invocation Cost (Common Set, 321 of ≤705 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (321-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 52.46 ms | 1104.17 s | 39,624 | 1.00× |
| 2 | **C++** | 58.88 ms | 1223.46 s | 35,429 | 1.12× |
| 3 | **Go** | 71.08 ms | 1382.20 s | 41,513 | 1.35× |
