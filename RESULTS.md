...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3875 measured (85.7% coverage).**
...
### Per-Invocation Cost (Common Set, 487 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (487-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 63.28 ms | 1479.45 s | 76,735 | 1.00× |
| 2 | **C++** | 68.06 ms | 1613.26 s | 60,331 | 1.08× |
| 3 | **Go** | 85.50 ms | 1869.70 s | 75,913 | 1.35× |
