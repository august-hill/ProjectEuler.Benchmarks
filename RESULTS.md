...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4465 measured (98.8% coverage).**
...
### Per-Invocation Cost (Common Set, 680 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (680-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.31 ms | 1768.19 s | 137,824 | 1.00× |
| 2 | **C++** | 78.17 ms | 1921.24 s | 101,250 | 1.04× |
| 3 | **Go** | 88.36 ms | 2141.53 s | 129,383 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 980 | 2026-09-06 |
