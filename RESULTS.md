...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4466 measured (98.8% coverage).**
...
### Per-Invocation Cost (Common Set, 681 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (681-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.14 ms | 1768.21 s | 138,024 | 1.00× |
| 2 | **C++** | 78.01 ms | 1921.26 s | 101,514 | 1.04× |
| 3 | **Go** | 88.18 ms | 2141.56 s | 129,692 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 981 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 983 | 2026-09-06 |
