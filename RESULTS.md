...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4411 measured (97.6% coverage).**
...
### Per-Invocation Cost (Common Set, 652 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (652-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.49 ms | 1759.16 s | 130,883 | 1.00× |
| 2 | **C++** | 78.55 ms | 1901.78 s | 95,245 | 1.04× |
| 3 | **Go** | 87.97 ms | 2129.34 s | 121,397 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 953 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 956 | 2026-09-05 |
