...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3684 measured (81.5% coverage).**
...
### Per-Invocation Cost (Common Set, 423 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (423-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 55.39 ms | 1199.45 s | 57,802 | 1.00× |
| 2 | **C++** | 58.21 ms | 1266.46 s | 46,817 | 1.05× |
| 3 | **Go** | 73.92 ms | 1475.94 s | 59,733 | 1.33× |
