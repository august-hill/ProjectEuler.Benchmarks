...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4442 measured (98.3% coverage).**
...
### Per-Invocation Cost (Common Set, 669 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (669-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.54 ms | 1763.53 s | 135,165 | 1.00× |
| 2 | **C++** | 76.74 ms | 1911.59 s | 98,969 | 1.03× |
| 3 | **Go** | 87.13 ms | 2135.49 s | 126,252 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 969 | 2026-09-06 |
