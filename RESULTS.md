...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4413 measured (97.6% coverage).**
...
### Per-Invocation Cost (Common Set, 653 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (653-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.31 ms | 1759.18 s | 131,121 | 1.00× |
| 2 | **C++** | 78.33 ms | 1901.80 s | 95,373 | 1.04× |
| 3 | **Go** | 87.45 ms | 2129.34 s | 121,568 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 954 | 2026-09-05 |
