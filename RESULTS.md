...
|------|----------|-----------|------|----------|------|
| 1 | **ARM64** | 25.44s | 0.71x | 196 | 53 |
| 2 | **Zig** | 26.56s | 0.74x | 65 | 10 |
| 3 | **C++** | 28.58s | 0.80x | 50 | 42 |
| 4 | **C** | 35.90s | 1.00x | 71 | 52 |
| 5 | **C#** | 45.87s | 1.28x | 53 | 1 |
| 6 | **Go** | 48.01s | 1.34x | 63 | 7 |
| 7 | **Rust** | 59.12s | 1.65x | 55 | 25 |
| 8 | **Java** | 79.38s | 2.21x | 51 | 2 |
| 9 | **JS** | 96.27s | 2.68x | 44 | 7 |
| 10 | **Python** | 673.25s | 18.75x | 41 | 0 |

*199 common problems, excluding 8 parked (algorithm redesign needed)*
...
- **Total solutions:** 2729
- **Pass rate:** 2708/2729 (99.2%)
- **Parked (algorithm redesign):** 8 problems across all languages
