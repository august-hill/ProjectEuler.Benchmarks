...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4394 measured (97.2% coverage).**
...
### Per-Invocation Cost (Common Set, 644 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (644-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.06 ms | 1750.28 s | 128,434 | 1.00× |
| 2 | **C++** | 76.72 ms | 1884.57 s | 93,466 | 1.04× |
| 3 | **Go** | 87.23 ms | 2122.72 s | 119,164 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 945 | 2026-09-05 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 947 | 2026-09-05 |
