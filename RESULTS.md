...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4337 measured (95.9% coverage).**
...
### Per-Invocation Cost (Common Set, 609 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (609-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.52 ms | 1700.78 s | 115,053 | 1.00× |
| 2 | **C++** | 74.82 ms | 1817.90 s | 86,651 | 1.02× |
| 3 | **Go** | 86.49 ms | 2077.23 s | 109,506 | 1.18× |
