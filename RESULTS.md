...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4384 measured (97.0% coverage).**
...
### Per-Invocation Cost (Common Set, 639 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (639-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.93 ms | 1726.39 s | 126,951 | 1.00× |
| 2 | **C++** | 76.21 ms | 1867.95 s | 92,638 | 1.03× |
| 3 | **Go** | 87.01 ms | 2113.28 s | 117,612 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 941 | 2026-09-05 |
