...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4415 measured (97.7% coverage).**
...
### Per-Invocation Cost (Common Set, 654 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (654-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.64 ms | 1760.58 s | 131,423 | 1.00× |
| 2 | **C++** | 78.64 ms | 1902.83 s | 95,552 | 1.04× |
| 3 | **Go** | 87.85 ms | 2131.05 s | 121,789 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 955 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 958 | 2026-09-06 |
