...
> **Scope: 4621 in-scope cells across 1007 problems × tiered languages — 3596 measured (77.8% coverage).**
...
### Per-Invocation Cost (Common Set, 326 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (326-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 52.89 ms | 1105.31 s | 40,247 | 1.00× |
| 2 | **C++** | 59.58 ms | 1225.64 s | 35,995 | 1.13× |
| 3 | **Go** | 72.15 ms | 1384.95 s | 42,274 | 1.36× |
