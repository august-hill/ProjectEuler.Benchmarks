...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3830 measured (84.7% coverage).**
...
### Per-Invocation Cost (Common Set, 472 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (472-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 62.62 ms | 1462.84 s | 71,230 | 1.00× |
| 2 | **C++** | 67.92 ms | 1608.33 s | 56,882 | 1.08× |
| 3 | **Go** | 88.10 ms | 1858.74 s | 72,907 | 1.41× |
