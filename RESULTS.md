...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4493 measured (99.4% coverage).**
...
### Per-Invocation Cost (Common Set, 695 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (695-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 76.09 ms | 1777.66 s | 143,606 | 1.00× |
| 2 | **C++** | 80.52 ms | 1964.89 s | 105,130 | 1.06× |
| 3 | **Go** | 89.11 ms | 2151.86 s | 134,170 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 995 | 2026-09-08 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 996 | 2026-09-08 |
