...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4485 measured (99.2% coverage).**
...
### Per-Invocation Cost (Common Set, 691 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (691-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 77.19 ms | 1777.39 s | 141,431 | 1.00× |
| 2 | **C++** | 80.32 ms | 1944.69 s | 103,796 | 1.04× |
| 3 | **Go** | 89.96 ms | 2149.96 s | 132,850 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 991 | 2026-09-08 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 992 | 2026-09-08 |
