...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4342 measured (96.0% coverage).**
...
### Per-Invocation Cost (Common Set, 614 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (614-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.25 ms | 1703.85 s | 116,570 | 1.00× |
| 2 | **C++** | 75.54 ms | 1822.57 s | 87,312 | 1.02× |
| 3 | **Go** | 87.23 ms | 2095.68 s | 110,369 | 1.17× |
