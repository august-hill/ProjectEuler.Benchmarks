...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4302 measured (95.2% coverage).**
...
### Per-Invocation Cost (Common Set, 598 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (598-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **C++** | 72.53 ms | 1801.32 s | 84,684 | 1.00× |
| 2 | **Rust** | 72.79 ms | 1657.82 s | 110,540 | 1.00× |
| 3 | **Go** | 85.28 ms | 2057.84 s | 105,996 | 1.18× |
