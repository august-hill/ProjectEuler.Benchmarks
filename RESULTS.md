...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4470 measured (98.9% coverage).**
...
### Per-Invocation Cost (Common Set, 683 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (683-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.30 ms | 1769.02 s | 138,606 | 1.00× |
| 2 | **C++** | 78.69 ms | 1926.92 s | 101,965 | 1.04× |
| 3 | **Go** | 88.37 ms | 2142.04 s | 130,389 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 983 | 2026-09-07 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 985 | 2026-09-07 |
