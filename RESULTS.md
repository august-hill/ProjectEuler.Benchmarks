...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3920 measured (86.7% coverage).**
...
### Per-Invocation Cost (Common Set, 502 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (502-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 64.61 ms | 1497.49 s | 81,876 | 1.00× |
| 2 | **C++** | 68.72 ms | 1630.68 s | 63,798 | 1.06× |
| 3 | **Go** | 84.29 ms | 1883.29 s | 79,686 | 1.30× |
