...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3937 measured (87.1% coverage).**
...
### Per-Invocation Cost (Common Set, 508 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (508-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 67.10 ms | 1534.24 s | 83,497 | 1.00× |
| 2 | **C++** | 70.41 ms | 1648.71 s | 65,312 | 1.05× |
| 3 | **Go** | 85.47 ms | 1900.19 s | 81,450 | 1.27× |
