...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3735 measured (82.6% coverage).**
...
### Per-Invocation Cost (Common Set, 440 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (440-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 58.30 ms | 1277.24 s | 62,017 | 1.00× |
| 2 | **C++** | 61.60 ms | 1299.30 s | 49,950 | 1.06× |
| 3 | **Go** | 77.16 ms | 1543.92 s | 63,888 | 1.32× |
