...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4335 measured (95.9% coverage).**
...
### Per-Invocation Cost (Common Set, 607 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (607-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.21 ms | 1700.73 s | 114,405 | 1.00× |
| 2 | **C++** | 74.22 ms | 1812.03 s | 86,297 | 1.00× |
| 3 | **Go** | 87.61 ms | 2077.20 s | 109,075 | 1.18× |
