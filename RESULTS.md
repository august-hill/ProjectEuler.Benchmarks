...
> **Scope: 4600 in-scope cells across 1000 problems × tiered languages — 3389 measured (73.7% coverage).**
...
### Per-Invocation Cost (Common Set, 256 of ≤700 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Total (256-problem common set) | Lines of code | vs Fastest |
|------|----------|--------------------:|--------------:|-----------:|
| 1 | **Rust** | 739.27 s | 31,024 | 1.00× |
| 2 | **C++** | 865.87 s | 28,423 | 1.17× |
| 3 | **Go** | 874.69 s | 32,476 | 1.18× |
