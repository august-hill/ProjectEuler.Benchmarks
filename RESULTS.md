...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3827 measured (84.6% coverage).**
...
### Per-Invocation Cost (Common Set, 471 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (471-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 62.52 ms | 1462.71 s | 70,974 | 1.00× |
| 2 | **C++** | 68.09 ms | 1608.31 s | 56,699 | 1.09× |
| 3 | **Go** | 88.18 ms | 1858.68 s | 72,777 | 1.41× |
