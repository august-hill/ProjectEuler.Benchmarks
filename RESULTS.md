...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4468 measured (98.8% coverage).**
...
### Per-Invocation Cost (Common Set, 682 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (682-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.39 ms | 1768.99 s | 138,338 | 1.00× |
| 2 | **C++** | 78.50 ms | 1926.50 s | 101,744 | 1.04× |
| 3 | **Go** | 88.38 ms | 2141.96 s | 130,161 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 982 | 2026-09-07 |
