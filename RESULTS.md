...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4338 measured (96.0% coverage).**
...
### Per-Invocation Cost (Common Set, 610 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (610-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.73 ms | 1701.18 s | 115,521 | 1.00× |
| 2 | **C++** | 75.01 ms | 1818.25 s | 86,802 | 1.02× |
| 3 | **Go** | 86.75 ms | 2077.76 s | 109,743 | 1.18× |
