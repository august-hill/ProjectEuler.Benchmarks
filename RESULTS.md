...
> **Scope: 4621 in-scope cells across 1007 problems × tiered languages — 3630 measured (78.6% coverage).**
...
### Per-Invocation Cost (Common Set, 338 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (338-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 52.03 ms | 1113.55 s | 43,033 | 1.00× |
| 2 | **C++** | 58.17 ms | 1230.08 s | 38,045 | 1.12× |
| 3 | **Go** | 72.27 ms | 1399.28 s | 44,958 | 1.39× |
