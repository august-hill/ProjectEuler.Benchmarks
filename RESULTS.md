...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4431 measured (98.0% coverage).**
...
### Per-Invocation Cost (Common Set, 663 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (663-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.10 ms | 1762.57 s | 133,738 | 1.00× |
| 2 | **C++** | 77.85 ms | 1908.88 s | 97,442 | 1.04× |
| 3 | **Go** | 87.19 ms | 2132.52 s | 124,406 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 963 | 2026-09-06 |
