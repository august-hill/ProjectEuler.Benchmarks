...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4372 measured (96.7% coverage).**
...
### Per-Invocation Cost (Common Set, 633 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (633-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.25 ms | 1718.61 s | 124,545 | 1.00× |
| 2 | **C++** | 75.07 ms | 1850.22 s | 91,714 | 1.02× |
| 3 | **Go** | 86.06 ms | 2105.55 s | 116,196 | 1.17× |
...
| **Go** | `go version go1.26.5 darwin/arm64` | 935 | 2026-09-04 |
