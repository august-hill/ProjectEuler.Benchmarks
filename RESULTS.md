...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4331 measured (95.8% coverage).**
...
### Per-Invocation Cost (Common Set, 603 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (603-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **C++** | 73.63 ms | 1808.14 s | 85,554 | 1.00× |
| 2 | **Rust** | 74.17 ms | 1697.60 s | 112,803 | 1.01× |
| 3 | **Go** | 87.19 ms | 2071.35 s | 107,591 | 1.18× |
