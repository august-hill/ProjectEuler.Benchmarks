...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4437 measured (98.1% coverage).**
...
### Per-Invocation Cost (Common Set, 666 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (666-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 74.77 ms | 1763.12 s | 134,449 | 1.00× |
| 2 | **C++** | 77.36 ms | 1911.52 s | 98,125 | 1.03× |
| 3 | **Go** | 87.42 ms | 2135.11 s | 125,458 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 966 | 2026-09-06 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 969 | 2026-09-06 |
