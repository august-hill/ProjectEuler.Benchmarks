...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4371 measured (96.7% coverage).**
...
### Per-Invocation Cost (Common Set, 632 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (632-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 73.18 ms | 1718.48 s | 124,332 | 1.00× |
| 2 | **C++** | 74.70 ms | 1848.56 s | 91,634 | 1.02× |
| 3 | **Go** | 86.00 ms | 2105.41 s | 115,995 | 1.18× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 935 | 2026-09-04 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 934 | 2026-09-04 |
