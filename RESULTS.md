...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4044 measured (89.4% coverage).**
...
### Per-Invocation Cost (Common Set, 544 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (544-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 70.71 ms | 1571.12 s | 94,164 | 1.00× |
| 2 | **C++** | 71.96 ms | 1674.19 s | 73,317 | 1.02× |
| 3 | **Go** | 86.48 ms | 1937.37 s | 91,773 | 1.22× |
