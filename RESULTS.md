...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4473 measured (98.9% coverage).**
...
### Per-Invocation Cost (Common Set, 684 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (684-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 75.47 ms | 1769.36 s | 138,774 | 1.00× |
| 2 | **C++** | 78.83 ms | 1927.19 s | 102,120 | 1.04× |
| 3 | **Go** | 88.42 ms | 2142.18 s | 130,534 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 984 | 2026-09-07 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 987 | 2026-09-07 |
