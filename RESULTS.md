...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4003 measured (88.5% coverage).**
...
### Per-Invocation Cost (Common Set, 530 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (530-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 67.68 ms | 1550.56 s | 89,505 | 1.00× |
| 2 | **C++** | 69.60 ms | 1658.35 s | 69,904 | 1.03× |
| 3 | **Go** | 83.87 ms | 1915.12 s | 87,076 | 1.24× |
