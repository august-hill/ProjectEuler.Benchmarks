...
> **Scope: 2500 in-scope cells across 300 problems × tiered languages — 2394 measured (95.8% coverage).**
...
|------|----------|--------------------:|--------------:|-----------:|
| 1 | **C++** | 7.97 s | 8,832 | 1.00× |
| 2 | **Go** | 9.03 s | 6,485 | 1.13× |
| 3 | **Zig** | 9.62 s | 7,005 | 1.21× |
| 4 | **Python** | 111.27 s | 4,430 | 13.96× |
