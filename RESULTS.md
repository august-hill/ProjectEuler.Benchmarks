...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3967 measured (87.7% coverage).**
...
### Per-Invocation Cost (Common Set, 518 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (518-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 66.62 ms | 1545.68 s | 86,308 | 1.00× |
| 2 | **C++** | 69.35 ms | 1655.33 s | 67,148 | 1.04× |
| 3 | **Go** | 83.96 ms | 1911.33 s | 84,252 | 1.26× |
