...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 3961 measured (87.6% coverage).**
...
### Per-Invocation Cost (Common Set, 516 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (516-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 67.41 ms | 1545.66 s | 85,836 | 1.00× |
| 2 | **C++** | 70.22 ms | 1655.33 s | 66,800 | 1.04× |
| 3 | **Go** | 84.87 ms | 1911.28 s | 83,735 | 1.26× |
