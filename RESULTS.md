...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4491 measured (99.3% coverage).**
...
### Per-Invocation Cost (Common Set, 694 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (694-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 76.80 ms | 1777.66 s | 143,266 | 1.00× |
| 2 | **C++** | 80.57 ms | 1964.84 s | 104,928 | 1.05× |
| 3 | **Go** | 89.44 ms | 2151.85 s | 133,724 | 1.16× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 994 | 2026-09-08 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 995 | 2026-09-08 |
