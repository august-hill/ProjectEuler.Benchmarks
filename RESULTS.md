...
> **Scope: 4521 in-scope cells across 1007 problems × tiered languages — 4487 measured (99.2% coverage).**
...
### Per-Invocation Cost (Common Set, 692 of ≤707 problems in scope)

![Per-Invocation Cost — Tier 3](charts/per_iter_total_tier3.png)

| Rank | Language | Geomean (692-problem common set) | Total (sum) | Lines of code | vs Fastest |
|------|----------|--------------------:|------------:|--------------:|-----------:|
| 1 | **Rust** | 77.14 ms | 1777.44 s | 141,650 | 1.00× |
| 2 | **C++** | 80.95 ms | 1962.62 s | 104,126 | 1.05× |
| 3 | **Go** | 89.93 ms | 2150.04 s | 133,113 | 1.17× |
...
| **C++** | `Apple clang version 21.0.0 (clang-2100.1.1.101)` | 992 | 2026-09-08 |
| **C#** | `10.0.101` | 200 | 2026-07-30 |
| **Go** | `go version go1.26.5 darwin/arm64` | 993 | 2026-09-08 |
