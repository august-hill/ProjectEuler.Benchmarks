...
PARKED = {'152','167','170','177','180','185','196'}
...
def main():
    ...
    ax.set_title('Per-Problem Slowdown vs C — Distribution Across 190 Problems\nMedian (line) and spread show consistency', fontsize=14, fontweight='bold')
    ax.legend()
    plt.tight_layout()
    ...
    print(f"\nRanking (190 common problems, total time):")
